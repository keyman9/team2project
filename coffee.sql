...
--
-- Name: coffee_cost; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE coffee_cost FROM PUBLIC;
REVOKE ALL ON TABLE coffee_cost FROM postgres;
GRANT ALL ON TABLE coffee_cost TO postgres;
...
--
-- Name: coffee_names; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE coffee_names FROM PUBLIC;
REVOKE ALL ON TABLE coffee_names FROM postgres;
GRANT ALL ON TABLE coffee_names TO postgres;
GRANT SELECT,INSERT ON TABLE coffee_names TO visiting;


--
-- Name: coffee_region; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE coffee_region FROM PUBLIC;
REVOKE ALL ON TABLE coffee_region FROM postgres;
GRANT ALL ON TABLE coffee_region TO postgres;
GRANT SELECT,INSERT ON TABLE coffee_region TO visiting;


--
-- Name: coffee_roast; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE coffee_roast FROM PUBLIC;
REVOKE ALL ON TABLE coffee_roast FROM postgres;
GRANT ALL ON TABLE coffee_roast TO postgres;
...
REVOKE ALL ON SEQUENCE region_region_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE region_region_id_seq FROM postgres;
GRANT ALL ON SEQUENCE region_region_id_seq TO postgres;
GRANT SELECT,UPDATE ON SEQUENCE region_region_id_seq TO visiting;


--
-- Name: roast; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE roast FROM PUBLIC;
REVOKE ALL ON TABLE roast FROM postgres;
GRANT ALL ON TABLE roast TO postgres;
GRANT SELECT,INSERT ON TABLE roast TO visiting;


--
-- Name: roast_roast_id_seq; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON SEQUENCE roast_roast_id_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE roast_roast_id_seq FROM postgres;
GRANT ALL ON SEQUENCE roast_roast_id_seq TO postgres;
GRANT SELECT,UPDATE ON SEQUENCE roast_roast_id_seq TO visiting;
